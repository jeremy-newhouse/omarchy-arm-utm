...
# It was a symlink to /home/gabriel/.local/share/omarchy, which ties the
# system to that user. It's converted into a real directory (as the pacman
# package would) and the home then points there instead.
